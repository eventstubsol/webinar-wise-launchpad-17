  ...
  return (
    <div className="w-full overflow-hidden py-16">
      ...
      <div className="relative mt-16 h-64 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] z-20">
        <div className="absolute inset-0 before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#111827,transparent_70%)] before:opacity-40" />

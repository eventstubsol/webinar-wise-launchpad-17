...
export const CustomerLogosSection = () => {
  ...
  return (
    <div className="h-screen w-full overflow-hidden">
      ...
      <div className="relative -mt-32 h-64 w-full overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)]">
        ...
        <Sparkles
          density={1200}
          className="absolute inset-x-0 bottom-0 h-full w-full [mask-image:radial-gradient(50%_50%,white,transparent_85%)] z-15"

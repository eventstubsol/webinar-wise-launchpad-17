...
export const FeaturesSection = () => {
  return (
    <section className="relative -mt-64 pt-64 pb-16 px-4 bg-gradient-to-b from-transparent via-transparent via-white to-white z-10">
          ...
          {features.slice(0, 3).map((feature, index) => (
            <div key={index} className="w-full relative max-w-xs mx-auto">
              ...
              <div className="relative shadow-xl bg-gray-900 border border-gray-800 px-6 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-start items-start">
                ...
                <p className="font-light text-base text-white mb-4 relative z-50">
                  {feature.description}
                </p>

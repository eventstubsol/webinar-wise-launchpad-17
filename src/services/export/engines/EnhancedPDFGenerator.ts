...
const createDynamicStyles = (branding: BrandingConfig) => StyleSheet.create({
  page: {
  ...
  header: {
    ...
    marginBottom: 30,
    paddingBottom: 20,
    borderBottom: `2px solid ${branding.primaryColor || '#3B82F6'}`,
  },
  logo: {
    width: 120,
    height: 40,
  ...
  sectionTitle: {
    ...
    marginBottom: 15,
    color: branding.primaryColor || '#1F2937',
    borderBottom: `1px solid ${branding.secondaryColor || '#E5E7EB'}`,
    paddingBottom: 5,
  },
  subsectionTitle: {
    fontSize: 16,
  ...
  metric: {
    ...
    borderRadius: 4,
    borderLeft: `4px solid ${branding.primaryColor || '#3B82F6'}`,
  },
  metricLabel: {
    fontSize: 12,
    fontWeight: 'bold',

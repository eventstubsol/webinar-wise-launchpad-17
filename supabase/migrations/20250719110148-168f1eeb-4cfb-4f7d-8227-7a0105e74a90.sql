...
-- Phase 1: Apply Missing Database Migration
-- This migration creates the calculate_webinar_status function and related infrastructure
...
-- Create a trigger function to automatically update webinar status
...
-- Create or replace the view for easy access to webinars with calculated status
...
-- Phase 2: Fix existing data by running the batch update function
SELECT * FROM batch_update_webinar_statuses();

-- Fix duplicate calculate_webinar_status functions
-- First, drop all existing versions
DROP FUNCTION IF EXISTS calculate_webinar_status(timestamp with time zone, integer, timestamp with time zone);
DROP FUNCTION IF EXISTS calculate_webinar_status(timestamp with time zone, integer);

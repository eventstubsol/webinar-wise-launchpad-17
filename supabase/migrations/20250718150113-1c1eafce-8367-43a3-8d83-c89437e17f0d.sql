...
-- Create table for storing OAuth states (this table is missing and causing the 500 error)
...
-- Allow system to manage OAuth states (edge functions need full access)
